...
double genlasso_objective_graph(const arma::mat &A, const arma::colvec &b, const arma::mat &D, const double lambda1, const double lambda2, const arma::colvec &x, const arma::colvec &z);
