#' @export
aug_admm_genlasso_for_graph <- function(A, b, D = diag(length(b)), M, C, lambda1 = 1.0, lambda2 = 1.0, rho = 1.0, alpha = 1.0,
  ...
  result <- aug_admm_genlasso_for_graph(A, b, D, M, C, lambda1, lambda2, reltol, abstol, maxiter, rho)
